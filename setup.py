...
install_requires = [
    ...
    "torchdata",
    "tensordict>=0.6.2,<=0.14.2",
    "transformers>=4.52.1,<6",
    "wandb",
    "packaging>=20.0",
...
# Separate from the legacy SGLang extra: the two serving stacks cannot be
# installed together. These core pins follow SGLang v0.5.10's own metadata.
QWEN35_REQUIRES = [
    "sglang==0.5.10",
    "transformers==5.3.0",
    "torch==2.9.1",
